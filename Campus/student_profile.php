...
<?php 
							...
							$query="select * from student_register where stu_id=".$_SESSION['UserID'];
							$res= mysqli_query($conn,$query);
							$row= $res->fetch_array();

							// $Job="select * from job_requirement Where company_id=".$row['company_id'];
							// 		 		$Ex=mysqli_query($conn,$Job) or die(mysqli_error($conn));
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="inner-header">
							 ...
							 <h1 style="color:white"><center><?php echo $row['first_name']." ".$row['last_name']; ?></center></h1> <br>
						</div>
				...
				<div class="row">
				 	<div class="col-lg-8 column">
				 		<div class="job-single-sec">
			 				...
			 				<div class="job-thumb"> <img src="<?php echo $row['upload_id']; ?>" alt="" height="100px;"> 
			 				</div><hr>
			 				<br>


				 				<div class="job-title2"><h4><?php echo $row['first_name']." ".$row['last_name'];?></h4><!-- <span class="job-is ft">Full time</span><i class="la la-heart-o"></i> --></div>
				 				<ul class="tags-jobs">
				 					<h4>Email</h4>
				 					<li><i ></i><?php echo $row['email'];?></li>
				 					<!-- <li><i class="la la-money"></i> Monthly Salary : <span>$3000 - $5000</span></li>
				 					<li><i class="la la-calendar-o"></i> Post Date: July 29, 2017</li> -->
				 				</ul>
				 				<span><strong>Gender</strong> :<?php echo $row['gender'];?></span>
				 			</div><!-- Job Head -->
				 	...
				 	<div class="col-lg-4 column">
				 		<!-- <div class="job-single-head style2">
			 				<div class="job-thumb"> <img src="<?php echo $row['upload_id']; ?>" alt="" height="75px;"> </div>
